...
namespace RestoranASP.Data.Migrations
{
    ...
    [Migration("20250712164624_IzmenaNarudzbine")]
    partial class IzmenaNarudzbine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestoranASP.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RestoranASP.Models.StavkaNarudzbine", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RestoranASP.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RestoranASP.Models.Narudzbina", b =>
                {
                    b.HasOne("RestoranASP.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RestoranASP.Models.StavkaNarudzbine", b =>
                {
                    b.HasOne("RestoranASP.Models.Jelo", "Jelo")
                        .WithMany("Narudzbine")
                        .HasForeignKey("JeloId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RestoranASP.Models.Narudzbina", "Narudzbina")
                        .WithMany("Jela")
